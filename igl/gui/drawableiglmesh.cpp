...
namespace IGLInterface {
    DrawableIGLMesh::DrawableIGLMesh() : DrawableMesh(V, F, NV, CV, NF, CF){
    }

    DrawableIGLMesh::DrawableIGLMesh(const SimpleIGLMesh& m) : IGLMesh(m), DrawableMesh(V, F, NV, CV, NF, CF) {
    }

    DrawableIGLMesh::DrawableIGLMesh(const IGLMesh& m) : IGLMesh(m), DrawableMesh(V, F, NV, CV, NF, CF){
    }
