...
int PolylinesCheck::maxYFace(std::vector<int> &list, const EigenMesh &mesh) {
    int max = 0;
    for(int i : list){
...
int PolylinesCheck::minYFace(std::vector<int> &list, const EigenMesh &mesh) {
    int min = 0;
    for(int i : list){
...
void PolylinesCheck::checkPlane(cg3::Array2D<int> &visibility, const EigenMesh &mesh, int indexPlane, int numberPlanes) {
...
void PolylinesCheck::checkVisibilityAllPlanes(const EigenMesh &mesh, cg3::Array2D<int> &visibility, int numberPlanes) {
...
void PolylinesCheck::minimizeNumberPlanes(std::vector<int>& survivedPlanes, cg3::Array2D<int> &visibility) {
