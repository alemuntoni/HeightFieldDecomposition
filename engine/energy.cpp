...
int Energy::BFGS(Box3D& b, BoxList& iterations, bool saveIt) const {
    ...
    }while (alfa > 1e-4 && gradient.norm() > 1e-4 && nIterations < 100);
    b.setMin(Pointd(x(0), x(1), x(2)));
    b.setMax(Pointd(x(3), x(4), x(5)));
    if (saveIt) iterations.addBox(b);
...
double Energy::gradientXMinComponentOld(const double*& a, double u1, double v1, double w1, double v2, double w2) {
    ...
    G_result =
            ...
            ((1.0L/4.0L)*a[48]*v1 - 1.0L/4.0L*a[48]*v2 + (1.0L/4.0L)*a[49]*u1*v1 - 1.0L/4.0L*a[49]*u1*v2 +
             (1.0L/4.0L)*a[50]*pow(u1, 2)*v1 - 1.0L/4.0L*a[50]*pow(u1, 2)*v2 + (1.0L/4.0L)*a[51]*pow(u1, 3)*v1 - 1.0L/4.0L*a[51]*pow(u1, 3)*v2 +
             (1.0L/8.0L)*a[52]*pow(v1, 2) - 1.0L/8.0L*a[52]*pow(v2, 2) + (1.0L/8.0L)*a[53]*u1*pow(v1, 2) - 1.0L/8.0L*a[53]*u1*pow(v2, 2) +
             (1.0L/8.0L)*a[54]*pow(u1, 2)*pow(v1, 2) - 1.0L/8.0L*a[54]*pow(u1, 2)*pow(v2, 2) + (1.0L/8.0L)*a[55]*pow(u1, 3)*pow(v1, 2) - 1.0L/8.0L*a[55]*pow(u1, 3)*pow(v2, 2) +
             (1.0L/12.0L)*a[56]*pow(v1, 3) - 1.0L/12.0L*a[56]*pow(v2, 3) + (1.0L/12.0L)*a[57]*u1*pow(v1, 3) - 1.0L/12.0L*a[57]*u1*pow(v2, 3) +
             (1.0L/12.0L)*a[58]*pow(u1, 2)*pow(v1, 3) - 1.0L/12.0L*a[58]*pow(u1, 2)*pow(v2, 3) + (1.0L/12.0L)*a[59]*pow(u1, 3)*pow(v1, 3) - 1.0L/12.0L*a[59]*pow(u1, 3)*pow(v2, 3) +
             (1.0L/16.0L)*a[60]*pow(v1, 4) - 1.0L/16.0L*a[60]*pow(v2, 4) + (1.0L/16.0L)*a[61]*u1*pow(v1, 4) - 1.0L/16.0L*a[61]*u1*pow(v2, 4) +
             (1.0L/16.0L)*a[62]*pow(u1, 2)*pow(v1, 4) - 1.0L/16.0L*a[62]*pow(u1, 2)*pow(v2, 4) + (1.0L/16.0L)*a[63]*pow(u1, 3)*pow(v1, 4) - 1.0L/16.0L*a[63]*pow(u1, 3)*pow(v2, 4))
            - pow(w1, 3) *
            ((1.0L/3.0L)*a[32]*v1 - 1.0L/3.0L*a[32]*v2 + (1.0L/3.0L)*a[33]*u1*v1 - 1.0L/3.0L*a[33]*u1*v2 +
             (1.0L/3.0L)*a[34]*pow(u1, 2)*v1 - 1.0L/3.0L*a[34]*pow(u1, 2)*v2 + (1.0L/3.0L)*a[35]*pow(u1, 3)*v1 - 1.0L/3.0L*a[35]*pow(u1, 3)*v2 +
             (1.0L/6.0L)*a[36]*pow(v1, 2) - 1.0L/6.0L*a[36]*pow(v2, 2) + (1.0L/6.0L)*a[37]*u1*pow(v1, 2) - 1.0L/6.0L*a[37]*u1*pow(v2, 2) +
             (1.0L/6.0L)*a[38]*pow(u1, 2)*pow(v1, 2) - 1.0L/6.0L*a[38]*pow(u1, 2)*pow(v2, 2) + (1.0L/6.0L)*a[39]*pow(u1, 3)*pow(v1, 2) - 1.0L/6.0L*a[39]*pow(u1, 3)*pow(v2, 2) +
             (1.0L/9.0L)*a[40]*pow(v1, 3) - 1.0L/9.0L*a[40]*pow(v2, 3) + (1.0L/9.0L)*a[41]*u1*pow(v1, 3) - 1.0L/9.0L*a[41]*u1*pow(v2, 3) +
             (1.0L/9.0L)*a[42]*pow(u1, 2)*pow(v1, 3) - 1.0L/9.0L*a[42]*pow(u1, 2)*pow(v2, 3) + (1.0L/9.0L)*a[43]*pow(u1, 3)*pow(v1, 3) - 1.0L/9.0L*a[43]*pow(u1, 3)*pow(v2, 3) +
             (1.0L/12.0L)*a[44]*pow(v1, 4) - 1.0L/12.0L*a[44]*pow(v2, 4) + (1.0L/12.0L)*a[45]*u1*pow(v1, 4) - 1.0L/12.0L*a[45]*u1*pow(v2, 4) +
             (1.0L/12.0L)*a[46]*pow(u1, 2)*pow(v1, 4) - 1.0L/12.0L*a[46]*pow(u1, 2)*pow(v2, 4) + (1.0L/12.0L)*a[47]*pow(u1, 3)*pow(v1, 4) - 1.0L/12.0L*a[47]*pow(u1, 3)*pow(v2, 4))
            - pow(w1, 2) *
            ((1.0L/2.0L)*a[16]*v1 - 1.0L/2.0L*a[16]*v2 + (1.0L/2.0L)*a[17]*u1*v1 - 1.0L/2.0L*a[17]*u1*v2 +
             (1.0L/2.0L)*a[18]*pow(u1, 2)*v1 - 1.0L/2.0L*a[18]*pow(u1, 2)*v2 + (1.0L/2.0L)*a[19]*pow(u1, 3)*v1 - 1.0L/2.0L*a[19]*pow(u1, 3)*v2 +
             (1.0L/4.0L)*a[20]*pow(v1, 2) - 1.0L/4.0L*a[20]*pow(v2, 2) + (1.0L/4.0L)*a[21]*u1*pow(v1, 2) - 1.0L/4.0L*a[21]*u1*pow(v2, 2) +
             (1.0L/4.0L)*a[22]*pow(u1, 2)*pow(v1, 2) - 1.0L/4.0L*a[22]*pow(u1, 2)*pow(v2, 2) + (1.0L/4.0L)*a[23]*pow(u1, 3)*pow(v1, 2) - 1.0L/4.0L*a[23]*pow(u1, 3)*pow(v2, 2) +
             (1.0L/6.0L)*a[24]*pow(v1, 3) - 1.0L/6.0L*a[24]*pow(v2, 3) + (1.0L/6.0L)*a[25]*u1*pow(v1, 3) - 1.0L/6.0L*a[25]*u1*pow(v2, 3) +
             (1.0L/6.0L)*a[26]*pow(u1, 2)*pow(v1, 3) - 1.0L/6.0L*a[26]*pow(u1, 2)*pow(v2, 3) + (1.0L/6.0L)*a[27]*pow(u1, 3)*pow(v1, 3) - 1.0L/6.0L*a[27]*pow(u1, 3)*pow(v2, 3) +
             (1.0L/8.0L)*a[28]*pow(v1, 4) - 1.0L/8.0L*a[28]*pow(v2, 4) + (1.0L/8.0L)*a[29]*u1*pow(v1, 4) - 1.0L/8.0L*a[29]*u1*pow(v2, 4) +
             (1.0L/8.0L)*a[30]*pow(u1, 2)*pow(v1, 4) - 1.0L/8.0L*a[30]*pow(u1, 2)*pow(v2, 4) + (1.0L/8.0L)*a[31]*pow(u1, 3)*pow(v1, 4) - 1.0L/8.0L*a[31]*pow(u1, 3)*pow(v2, 4))
            - w1 *
            (a[0]*v1 - a[0]*v2 + a[1]*u1*v1 - a[1]*u1*v2 +
             (1.0L/3.0L)*a[10]*pow(u1, 2)*pow(v1, 3) - 1.0L/3.0L*a[10]*pow(u1, 2)*pow(v2, 3) + (1.0L/3.0L)*a[11]*pow(u1, 3)*pow(v1, 3) - 1.0L/3.0L*a[11]*pow(u1, 3)*pow(v2, 3) +
             (1.0L/4.0L)*a[12]*pow(v1, 4) - 1.0L/4.0L*a[12]*pow(v2, 4) + (1.0L/4.0L)*a[13]*u1*pow(v1, 4) - 1.0L/4.0L*a[13]*u1*pow(v2, 4) +
             (1.0L/4.0L)*a[14]*pow(u1, 2)*pow(v1, 4) - 1.0L/4.0L*a[14]*pow(u1, 2)*pow(v2, 4) + (1.0L/4.0L)*a[15]*pow(u1, 3)*pow(v1, 4) - 1.0L/4.0L*a[15]*pow(u1, 3)*pow(v2, 4) +
             a[2]*pow(u1, 2)*v1 - a[2]*pow(u1, 2)*v2 + a[3]*pow(u1, 3)*v1 - a[3]*pow(u1, 3)*v2 +
             (1.0L/2.0L)*a[4]*pow(v1, 2) - 1.0L/2.0L*a[4]*pow(v2, 2) + (1.0L/2.0L)*a[5]*u1*pow(v1, 2) - 1.0L/2.0L*a[5]*u1*pow(v2, 2) +
             (1.0L/2.0L)*a[6]*pow(u1, 2)*pow(v1, 2) - 1.0L/2.0L*a[6]*pow(u1, 2)*pow(v2, 2) + (1.0L/2.0L)*a[7]*pow(u1, 3)*pow(v1, 2) - 1.0L/2.0L*a[7]*pow(u1, 3)*pow(v2, 2) +
             (1.0L/3.0L)*a[8]*pow(v1, 3) - 1.0L/3.0L*a[8]*pow(v2, 3) + (1.0L/3.0L)*a[9]*u1*pow(v1, 3) - 1.0L/3.0L*a[9]*u1*pow(v2, 3))
            + pow(w2, 4) *
             ((1.0L/4.0L)*a[48]*v1 - 1.0L/4.0L*a[48]*v2 + (1.0L/4.0L)*a[49]*u1*v1 - 1.0L/4.0L*a[49]*u1*v2 +
             (1.0L/4.0L)*a[50]*pow(u1, 2)*v1 - 1.0L/4.0L*a[50]*pow(u1, 2)*v2 + (1.0L/4.0L)*a[51]*pow(u1, 3)*v1 - 1.0L/4.0L*a[51]*pow(u1, 3)*v2 +
             (1.0L/8.0L)*a[52]*pow(v1, 2) - 1.0L/8.0L*a[52]*pow(v2, 2) + (1.0L/8.0L)*a[53]*u1*pow(v1, 2) - 1.0L/8.0L*a[53]*u1*pow(v2, 2) +
...
double Energy::gradientYMinComponentOld(const double*& a, double u1, double v1, double w1, double u2, double w2) {
    double G_result;
    G_result =
            -pow(w1, 4) *
            ((1.0L/4.0L)*a[48]*u1 - 1.0L/4.0L*a[48]*u2 + (1.0L/8.0L)*a[49]*pow(u1, 2) - 1.0L/8.0L*a[49]*pow(u2, 2) +
             (1.0L/12.0L)*a[50]*pow(u1, 3) - 1.0L/12.0L*a[50]*pow(u2, 3) + (1.0L/16.0L)*a[51]*pow(u1, 4) - 1.0L/16.0L*a[51]*pow(u2, 4) +
             (1.0L/4.0L)*a[52]*u1*v1 - 1.0L/4.0L*a[52]*u2*v1 + (1.0L/8.0L)*a[53]*pow(u1, 2)*v1 - 1.0L/8.0L*a[53]*pow(u2, 2)*v1 +
             (1.0L/12.0L)*a[54]*pow(u1, 3)*v1 - 1.0L/12.0L*a[54]*pow(u2, 3)*v1 + (1.0L/16.0L)*a[55]*pow(u1, 4)*v1 - 1.0L/16.0L*a[55]*pow(u2, 4)*v1 +
             (1.0L/4.0L)*a[56]*u1*pow(v1, 2) - 1.0L/4.0L*a[56]*u2*pow(v1, 2) + (1.0L/8.0L)*a[57]*pow(u1, 2)*pow(v1, 2) - 1.0L/8.0L*a[57]*pow(u2, 2)*pow(v1, 2) +
             (1.0L/12.0L)*a[58]*pow(u1, 3)*pow(v1, 2) - 1.0L/12.0L*a[58]*pow(u2, 3)*pow(v1, 2) + (1.0L/16.0L)*a[59]*pow(u1, 4)*pow(v1, 2) - 1.0L/16.0L*a[59]*pow(u2, 4)*pow(v1, 2) +
             (1.0L/4.0L)*a[60]*u1*pow(v1, 3) - 1.0L/4.0L*a[60]*u2*pow(v1, 3) + (1.0L/8.0L)*a[61]*pow(u1, 2)*pow(v1, 3) - 1.0L/8.0L*a[61]*pow(u2, 2)*pow(v1, 3) +
             (1.0L/12.0L)*a[62]*pow(u1, 3)*pow(v1, 3) - 1.0L/12.0L*a[62]*pow(u2, 3)*pow(v1, 3) + (1.0L/16.0L)*a[63]*pow(u1, 4)*pow(v1, 3) - 1.0L/16.0L*a[63]*pow(u2, 4)*pow(v1, 3))
            - pow(w1, 3) *
            ((1.0L/3.0L)*a[32]*u1 - 1.0L/3.0L*a[32]*u2 + (1.0L/6.0L)*a[33]*pow(u1, 2) - 1.0L/6.0L*a[33]*pow(u2, 2) +
             (1.0L/9.0L)*a[34]*pow(u1, 3) - 1.0L/9.0L*a[34]*pow(u2, 3) + (1.0L/12.0L)*a[35]*pow(u1, 4) - 1.0L/12.0L*a[35]*pow(u2, 4) +
             (1.0L/3.0L)*a[36]*u1*v1 - 1.0L/3.0L*a[36]*u2*v1 + (1.0L/6.0L)*a[37]*pow(u1, 2)*v1 - 1.0L/6.0L*a[37]*pow(u2, 2)*v1 +
             (1.0L/9.0L)*a[38]*pow(u1, 3)*v1 - 1.0L/9.0L*a[38]*pow(u2, 3)*v1 + (1.0L/12.0L)*a[39]*pow(u1, 4)*v1 - 1.0L/12.0L*a[39]*pow(u2, 4)*v1 +
             (1.0L/3.0L)*a[40]*u1*pow(v1, 2) - 1.0L/3.0L*a[40]*u2*pow(v1, 2) + (1.0L/6.0L)*a[41]*pow(u1, 2)*pow(v1, 2) - 1.0L/6.0L*a[41]*pow(u2, 2)*pow(v1, 2) +
             (1.0L/9.0L)*a[42]*pow(u1, 3)*pow(v1, 2) - 1.0L/9.0L*a[42]*pow(u2, 3)*pow(v1, 2) + (1.0L/12.0L)*a[43]*pow(u1, 4)*pow(v1, 2) - 1.0L/12.0L*a[43]*pow(u2, 4)*pow(v1, 2) +
             (1.0L/3.0L)*a[44]*u1*pow(v1, 3) - 1.0L/3.0L*a[44]*u2*pow(v1, 3) + (1.0L/6.0L)*a[45]*pow(u1, 2)*pow(v1, 3) - 1.0L/6.0L*a[45]*pow(u2, 2)*pow(v1, 3) +
             (1.0L/9.0L)*a[46]*pow(u1, 3)*pow(v1, 3) - 1.0L/9.0L*a[46]*pow(u2, 3)*pow(v1, 3) + (1.0L/12.0L)*a[47]*pow(u1, 4)*pow(v1, 3) - 1.0L/12.0L*a[47]*pow(u2, 4)*pow(v1, 3))
            - pow(w1, 2) *
            ((1.0L/2.0L)*a[16]*u1 - 1.0L/2.0L*a[16]*u2 + (1.0L/4.0L)*a[17]*pow(u1, 2) - 1.0L/4.0L*a[17]*pow(u2, 2) +
             (1.0L/6.0L)*a[18]*pow(u1, 3) - 1.0L/6.0L*a[18]*pow(u2, 3) + (1.0L/8.0L)*a[19]*pow(u1, 4) - 1.0L/8.0L*a[19]*pow(u2, 4) +
             (1.0L/2.0L)*a[20]*u1*v1 - 1.0L/2.0L*a[20]*u2*v1 + (1.0L/4.0L)*a[21]*pow(u1, 2)*v1 - 1.0L/4.0L*a[21]*pow(u2, 2)*v1 +
             (1.0L/6.0L)*a[22]*pow(u1, 3)*v1 - 1.0L/6.0L*a[22]*pow(u2, 3)*v1 + (1.0L/8.0L)*a[23]*pow(u1, 4)*v1 - 1.0L/8.0L*a[23]*pow(u2, 4)*v1 +
             (1.0L/2.0L)*a[24]*u1*pow(v1, 2) - 1.0L/2.0L*a[24]*u2*pow(v1, 2) + (1.0L/4.0L)*a[25]*pow(u1, 2)*pow(v1, 2) - 1.0L/4.0L*a[25]*pow(u2, 2)*pow(v1, 2) +
             (1.0L/6.0L)*a[26]*pow(u1, 3)*pow(v1, 2) - 1.0L/6.0L*a[26]*pow(u2, 3)*pow(v1, 2) + (1.0L/8.0L)*a[27]*pow(u1, 4)*pow(v1, 2) - 1.0L/8.0L*a[27]*pow(u2, 4)*pow(v1, 2) +
             (1.0L/2.0L)*a[28]*u1*pow(v1, 3) - 1.0L/2.0L*a[28]*u2*pow(v1, 3) + (1.0L/4.0L)*a[29]*pow(u1, 2)*pow(v1, 3) - 1.0L/4.0L*a[29]*pow(u2, 2)*pow(v1, 3) +
             (1.0L/6.0L)*a[30]*pow(u1, 3)*pow(v1, 3) - 1.0L/6.0L*a[30]*pow(u2, 3)*pow(v1, 3) + (1.0L/8.0L)*a[31]*pow(u1, 4)*pow(v1, 3) - 1.0L/8.0L*a[31]*pow(u2, 4)*pow(v1, 3))
            - w1 *
            (a[0]*u1 - a[0]*u2 + (1.0L/2.0L)*a[1]*pow(u1, 2) - 1.0L/2.0L*a[1]*pow(u2, 2) +
             (1.0L/3.0L)*a[10]*pow(u1, 3)*pow(v1, 2) - 1.0L/3.0L*a[10]*pow(u2, 3)*pow(v1, 2) + (1.0L/4.0L)*a[11]*pow(u1, 4)*pow(v1, 2) - 1.0L/4.0L*a[11]*pow(u2, 4)*pow(v1, 2) +
             a[12]*u1*pow(v1, 3) - a[12]*u2*pow(v1, 3) + (1.0L/2.0L)*a[13]*pow(u1, 2)*pow(v1, 3) - 1.0L/2.0L*a[13]*pow(u2, 2)*pow(v1, 3) +
             (1.0L/3.0L)*a[14]*pow(u1, 3)*pow(v1, 3) - 1.0L/3.0L*a[14]*pow(u2, 3)*pow(v1, 3) + (1.0L/4.0L)*a[15]*pow(u1, 4)*pow(v1, 3) - 1.0L/4.0L*a[15]*pow(u2, 4)*pow(v1, 3) +
             (1.0L/3.0L)*a[2]*pow(u1, 3) - 1.0L/3.0L*a[2]*pow(u2, 3) + (1.0L/4.0L)*a[3]*pow(u1, 4) - 1.0L/4.0L*a[3]*pow(u2, 4) +
             a[4]*u1*v1 - a[4]*u2*v1 + (1.0L/2.0L)*a[5]*pow(u1, 2)*v1 - 1.0L/2.0L*a[5]*pow(u2, 2)*v1 +
             (1.0L/3.0L)*a[6]*pow(u1, 3)*v1 - 1.0L/3.0L*a[6]*pow(u2, 3)*v1 + (1.0L/4.0L)*a[7]*pow(u1, 4)*v1 - 1.0L/4.0L*a[7]*pow(u2, 4)*v1 +
             a[8]*u1*pow(v1, 2) - a[8]*u2*pow(v1, 2) + (1.0L/2.0L)*a[9]*pow(u1, 2)*pow(v1, 2) - 1.0L/2.0L*a[9]*pow(u2, 2)*pow(v1, 2))
            + pow(w2, 4) *
            ((1.0L/4.0L)*a[48]*u1 - 1.0L/4.0L*a[48]*u2 + (1.0L/8.0L)*a[49]*pow(u1, 2) - 1.0L/8.0L*a[49]*pow(u2, 2) +
             (1.0L/12.0L)*a[50]*pow(u1, 3) - 1.0L/12.0L*a[50]*pow(u2, 3) + (1.0L/16.0L)*a[51]*pow(u1, 4) - 1.0L/16.0L*a[51]*pow(u2, 4) +
             (1.0L/4.0L)*a[52]*u1*v1 - 1.0L/4.0L*a[52]*u2*v1 + (1.0L/8.0L)*a[53]*pow(u1, 2)*v1 - 1.0L/8.0L*a[53]*pow(u2, 2)*v1 +
...
double Energy::gradientZMinComponentOld(const double*& a, double u1, double v1, double w1, double u2, double v2) {
    double G_result;
    G_result =
...
double Energy::gradientXMaxComponentOld(const double*& a, double v1, double w1, double u2, double v2, double w2) {
    double G_result;
    G_result =
            -pow(w1, 4) *
            (-1.0L/4.0L*a[48]*v1 + (1.0L/4.0L)*a[48]*v2 - 1.0L/4.0L*a[49]*u2*v1 + (1.0L/4.0L)*a[49]*u2*v2 -
             1.0L/4.0L*a[50]*pow(u2, 2)*v1 + (1.0L/4.0L)*a[50]*pow(u2, 2)*v2 - 1.0L/4.0L*a[51]*pow(u2, 3)*v1 + (1.0L/4.0L)*a[51]*pow(u2, 3)*v2 -
             1.0L/8.0L*a[52]*pow(v1, 2) + (1.0L/8.0L)*a[52]*pow(v2, 2) - 1.0L/8.0L*a[53]*u2*pow(v1, 2) + (1.0L/8.0L)*a[53]*u2*pow(v2, 2) -
             1.0L/8.0L*a[54]*pow(u2, 2)*pow(v1, 2) + (1.0L/8.0L)*a[54]*pow(u2, 2)*pow(v2, 2) - 1.0L/8.0L*a[55]*pow(u2, 3)*pow(v1, 2) + (1.0L/8.0L)*a[55]*pow(u2, 3)*pow(v2, 2) -
             1.0L/12.0L*a[56]*pow(v1, 3) + (1.0L/12.0L)*a[56]*pow(v2, 3) - 1.0L/12.0L*a[57]*u2*pow(v1, 3) + (1.0L/12.0L)*a[57]*u2*pow(v2, 3) -
             1.0L/12.0L*a[58]*pow(u2, 2)*pow(v1, 3) + (1.0L/12.0L)*a[58]*pow(u2, 2)*pow(v2, 3) - 1.0L/12.0L*a[59]*pow(u2, 3)*pow(v1, 3) + (1.0L/12.0L)*a[59]*pow(u2, 3)*pow(v2, 3) -
             1.0L/16.0L*a[60]*pow(v1, 4) + (1.0L/16.0L)*a[60]*pow(v2, 4) - 1.0L/16.0L*a[61]*u2*pow(v1, 4) + (1.0L/16.0L)*a[61]*u2*pow(v2, 4) -
             1.0L/16.0L*a[62]*pow(u2, 2)*pow(v1, 4) + (1.0L/16.0L)*a[62]*pow(u2, 2)*pow(v2, 4) - 1.0L/16.0L*a[63]*pow(u2, 3)*pow(v1, 4) + (1.0L/16.0L)*a[63]*pow(u2, 3)*pow(v2, 4))
            - pow(w1, 3) *
            (-1.0L/3.0L*a[32]*v1 + (1.0L/3.0L)*a[32]*v2 - 1.0L/3.0L*a[33]*u2*v1 + (1.0L/3.0L)*a[33]*u2*v2 -
             1.0L/3.0L*a[34]*pow(u2, 2)*v1 + (1.0L/3.0L)*a[34]*pow(u2, 2)*v2 - 1.0L/3.0L*a[35]*pow(u2, 3)*v1 + (1.0L/3.0L)*a[35]*pow(u2, 3)*v2 -
             1.0L/6.0L*a[36]*pow(v1, 2) + (1.0L/6.0L)*a[36]*pow(v2, 2) - 1.0L/6.0L*a[37]*u2*pow(v1, 2) + (1.0L/6.0L)*a[37]*u2*pow(v2, 2) -
             1.0L/6.0L*a[38]*pow(u2, 2)*pow(v1, 2) + (1.0L/6.0L)*a[38]*pow(u2, 2)*pow(v2, 2) - 1.0L/6.0L*a[39]*pow(u2, 3)*pow(v1, 2) + (1.0L/6.0L)*a[39]*pow(u2, 3)*pow(v2, 2) -
             1.0L/9.0L*a[40]*pow(v1, 3) + (1.0L/9.0L)*a[40]*pow(v2, 3) - 1.0L/9.0L*a[41]*u2*pow(v1, 3) + (1.0L/9.0L)*a[41]*u2*pow(v2, 3) -
             1.0L/9.0L*a[42]*pow(u2, 2)*pow(v1, 3) + (1.0L/9.0L)*a[42]*pow(u2, 2)*pow(v2, 3) - 1.0L/9.0L*a[43]*pow(u2, 3)*pow(v1, 3) + (1.0L/9.0L)*a[43]*pow(u2, 3)*pow(v2, 3) -
             1.0L/12.0L*a[44]*pow(v1, 4) + (1.0L/12.0L)*a[44]*pow(v2, 4) - 1.0L/12.0L*a[45]*u2*pow(v1, 4) + (1.0L/12.0L)*a[45]*u2*pow(v2, 4) -
             1.0L/12.0L*a[46]*pow(u2, 2)*pow(v1, 4) + (1.0L/12.0L)*a[46]*pow(u2, 2)*pow(v2, 4) - 1.0L/12.0L*a[47]*pow(u2, 3)*pow(v1, 4) + (1.0L/12.0L)*a[47]*pow(u2, 3)*pow(v2, 4))
            - pow(w1, 2) *
            (-1.0L/2.0L*a[16]*v1 + (1.0L/2.0L)*a[16]*v2 - 1.0L/2.0L*a[17]*u2*v1 + (1.0L/2.0L)*a[17]*u2*v2 -
             1.0L/2.0L*a[18]*pow(u2, 2)*v1 + (1.0L/2.0L)*a[18]*pow(u2, 2)*v2 - 1.0L/2.0L*a[19]*pow(u2, 3)*v1 + (1.0L/2.0L)*a[19]*pow(u2, 3)*v2 -
             1.0L/4.0L*a[20]*pow(v1, 2) + (1.0L/4.0L)*a[20]*pow(v2, 2) - 1.0L/4.0L*a[21]*u2*pow(v1, 2) + (1.0L/4.0L)*a[21]*u2*pow(v2, 2) -
             1.0L/4.0L*a[22]*pow(u2, 2)*pow(v1, 2) + (1.0L/4.0L)*a[22]*pow(u2, 2)*pow(v2, 2) - 1.0L/4.0L*a[23]*pow(u2, 3)*pow(v1, 2) + (1.0L/4.0L)*a[23]*pow(u2, 3)*pow(v2, 2) -
             1.0L/6.0L*a[24]*pow(v1, 3) + (1.0L/6.0L)*a[24]*pow(v2, 3) - 1.0L/6.0L*a[25]*u2*pow(v1, 3) + (1.0L/6.0L)*a[25]*u2*pow(v2, 3) -
             1.0L/6.0L*a[26]*pow(u2, 2)*pow(v1, 3) + (1.0L/6.0L)*a[26]*pow(u2, 2)*pow(v2, 3) - 1.0L/6.0L*a[27]*pow(u2, 3)*pow(v1, 3) + (1.0L/6.0L)*a[27]*pow(u2, 3)*pow(v2, 3) -
             1.0L/8.0L*a[28]*pow(v1, 4) + (1.0L/8.0L)*a[28]*pow(v2, 4) - 1.0L/8.0L*a[29]*u2*pow(v1, 4) + (1.0L/8.0L)*a[29]*u2*pow(v2, 4) -
             1.0L/8.0L*a[30]*pow(u2, 2)*pow(v1, 4) + (1.0L/8.0L)*a[30]*pow(u2, 2)*pow(v2, 4) - 1.0L/8.0L*a[31]*pow(u2, 3)*pow(v1, 4) + (1.0L/8.0L)*a[31]*pow(u2, 3)*pow(v2, 4))
            - w1 *
            (-a[0]*v1 + a[0]*v2 - a[1]*u2*v1 + a[1]*u2*v2 -
             1.0L/3.0L*a[10]*pow(u2, 2)*pow(v1, 3) + (1.0L/3.0L)*a[10]*pow(u2, 2)*pow(v2, 3) - 1.0L/3.0L*a[11]*pow(u2, 3)*pow(v1, 3) + (1.0L/3.0L)*a[11]*pow(u2, 3)*pow(v2, 3) -
             1.0L/4.0L*a[12]*pow(v1, 4) + (1.0L/4.0L)*a[12]*pow(v2, 4) - 1.0L/4.0L*a[13]*u2*pow(v1, 4) + (1.0L/4.0L)*a[13]*u2*pow(v2, 4) -
             1.0L/4.0L*a[14]*pow(u2, 2)*pow(v1, 4) + (1.0L/4.0L)*a[14]*pow(u2, 2)*pow(v2, 4) - 1.0L/4.0L*a[15]*pow(u2, 3)*pow(v1, 4) + (1.0L/4.0L)*a[15]*pow(u2, 3)*pow(v2, 4) -
             a[2]*pow(u2, 2)*v1 + a[2]*pow(u2, 2)*v2 - a[3]*pow(u2, 3)*v1 + a[3]*pow(u2, 3)*v2 -
             1.0L/2.0L*a[4]*pow(v1, 2) + (1.0L/2.0L)*a[4]*pow(v2, 2) - 1.0L/2.0L*a[5]*u2*pow(v1, 2) + (1.0L/2.0L)*a[5]*u2*pow(v2, 2) -
             1.0L/2.0L*a[6]*pow(u2, 2)*pow(v1, 2) + (1.0L/2.0L)*a[6]*pow(u2, 2)*pow(v2, 2) - 1.0L/2.0L*a[7]*pow(u2, 3)*pow(v1, 2) + (1.0L/2.0L)*a[7]*pow(u2, 3)*pow(v2, 2) -
             1.0L/3.0L*a[8]*pow(v1, 3) + (1.0L/3.0L)*a[8]*pow(v2, 3) - 1.0L/3.0L*a[9]*u2*pow(v1, 3) + (1.0L/3.0L)*a[9]*u2*pow(v2, 3))
            + pow(w2, 4) *
            (-1.0L/4.0L*a[48]*v1 + (1.0L/4.0L)*a[48]*v2 - 1.0L/4.0L*a[49]*u2*v1 + (1.0L/4.0L)*a[49]*u2*v2 -
             1.0L/4.0L*a[50]*pow(u2, 2)*v1 + (1.0L/4.0L)*a[50]*pow(u2, 2)*v2 - 1.0L/4.0L*a[51]*pow(u2, 3)*v1 + (1.0L/4.0L)*a[51]*pow(u2, 3)*v2 -
             1.0L/8.0L*a[52]*pow(v1, 2) + (1.0L/8.0L)*a[52]*pow(v2, 2) - 1.0L/8.0L*a[53]*u2*pow(v1, 2) + (1.0L/8.0L)*a[53]*u2*pow(v2, 2) -
...
double Energy::gradientYMaxComponentOld(const double*& a, double u1, double w1, double u2, double v2, double w2) {
    double G_result;
    G_result =
            -pow(w1, 4) *
            (-1.0L/4.0L*a[48]*u1 + (1.0L/4.0L)*a[48]*u2 - 1.0L/8.0L*a[49]*pow(u1, 2) + (1.0L/8.0L)*a[49]*pow(u2, 2) -
             1.0L/12.0L*a[50]*pow(u1, 3) + (1.0L/12.0L)*a[50]*pow(u2, 3) - 1.0L/16.0L*a[51]*pow(u1, 4) + (1.0L/16.0L)*a[51]*pow(u2, 4) -
             1.0L/4.0L*a[52]*u1*v2 + (1.0L/4.0L)*a[52]*u2*v2 - 1.0L/8.0L*a[53]*pow(u1, 2)*v2 + (1.0L/8.0L)*a[53]*pow(u2, 2)*v2 -
             1.0L/12.0L*a[54]*pow(u1, 3)*v2 + (1.0L/12.0L)*a[54]*pow(u2, 3)*v2 - 1.0L/16.0L*a[55]*pow(u1, 4)*v2 + (1.0L/16.0L)*a[55]*pow(u2, 4)*v2 -
             1.0L/4.0L*a[56]*u1*pow(v2, 2) + (1.0L/4.0L)*a[56]*u2*pow(v2, 2) - 1.0L/8.0L*a[57]*pow(u1, 2)*pow(v2, 2) + (1.0L/8.0L)*a[57]*pow(u2, 2)*pow(v2, 2) -
             1.0L/12.0L*a[58]*pow(u1, 3)*pow(v2, 2) + (1.0L/12.0L)*a[58]*pow(u2, 3)*pow(v2, 2) - 1.0L/16.0L*a[59]*pow(u1, 4)*pow(v2, 2) + (1.0L/16.0L)*a[59]*pow(u2, 4)*pow(v2, 2) -
             1.0L/4.0L*a[60]*u1*pow(v2, 3) + (1.0L/4.0L)*a[60]*u2*pow(v2, 3) - 1.0L/8.0L*a[61]*pow(u1, 2)*pow(v2, 3) + (1.0L/8.0L)*a[61]*pow(u2, 2)*pow(v2, 3) -
             1.0L/12.0L*a[62]*pow(u1, 3)*pow(v2, 3) + (1.0L/12.0L)*a[62]*pow(u2, 3)*pow(v2, 3) - 1.0L/16.0L*a[63]*pow(u1, 4)*pow(v2, 3) + (1.0L/16.0L)*a[63]*pow(u2, 4)*pow(v2, 3))
            - pow(w1, 3) *
            (-1.0L/3.0L*a[32]*u1 + (1.0L/3.0L)*a[32]*u2 - 1.0L/6.0L*a[33]*pow(u1, 2) + (1.0L/6.0L)*a[33]*pow(u2, 2) -
             1.0L/9.0L*a[34]*pow(u1, 3) + (1.0L/9.0L)*a[34]*pow(u2, 3) - 1.0L/12.0L*a[35]*pow(u1, 4) + (1.0L/12.0L)*a[35]*pow(u2, 4) -
             1.0L/3.0L*a[36]*u1*v2 + (1.0L/3.0L)*a[36]*u2*v2 - 1.0L/6.0L*a[37]*pow(u1, 2)*v2 + (1.0L/6.0L)*a[37]*pow(u2, 2)*v2 -
             1.0L/9.0L*a[38]*pow(u1, 3)*v2 + (1.0L/9.0L)*a[38]*pow(u2, 3)*v2 - 1.0L/12.0L*a[39]*pow(u1, 4)*v2 + (1.0L/12.0L)*a[39]*pow(u2, 4)*v2 -
             1.0L/3.0L*a[40]*u1*pow(v2, 2) + (1.0L/3.0L)*a[40]*u2*pow(v2, 2) - 1.0L/6.0L*a[41]*pow(u1, 2)*pow(v2, 2) + (1.0L/6.0L)*a[41]*pow(u2, 2)*pow(v2, 2) -
             1.0L/9.0L*a[42]*pow(u1, 3)*pow(v2, 2) + (1.0L/9.0L)*a[42]*pow(u2, 3)*pow(v2, 2) - 1.0L/12.0L*a[43]*pow(u1, 4)*pow(v2, 2) + (1.0L/12.0L)*a[43]*pow(u2, 4)*pow(v2, 2) -
             1.0L/3.0L*a[44]*u1*pow(v2, 3) + (1.0L/3.0L)*a[44]*u2*pow(v2, 3) - 1.0L/6.0L*a[45]*pow(u1, 2)*pow(v2, 3) + (1.0L/6.0L)*a[45]*pow(u2, 2)*pow(v2, 3) -
             1.0L/9.0L*a[46]*pow(u1, 3)*pow(v2, 3) + (1.0L/9.0L)*a[46]*pow(u2, 3)*pow(v2, 3) - 1.0L/12.0L*a[47]*pow(u1, 4)*pow(v2, 3) + (1.0L/12.0L)*a[47]*pow(u2, 4)*pow(v2, 3))
            - pow(w1, 2) *
            (-1.0L/2.0L*a[16]*u1 + (1.0L/2.0L)*a[16]*u2 - 1.0L/4.0L*a[17]*pow(u1, 2) + (1.0L/4.0L)*a[17]*pow(u2, 2) -
             1.0L/6.0L*a[18]*pow(u1, 3) + (1.0L/6.0L)*a[18]*pow(u2, 3) - 1.0L/8.0L*a[19]*pow(u1, 4) + (1.0L/8.0L)*a[19]*pow(u2, 4) -
             1.0L/2.0L*a[20]*u1*v2 + (1.0L/2.0L)*a[20]*u2*v2 - 1.0L/4.0L*a[21]*pow(u1, 2)*v2 + (1.0L/4.0L)*a[21]*pow(u2, 2)*v2 -
             1.0L/6.0L*a[22]*pow(u1, 3)*v2 + (1.0L/6.0L)*a[22]*pow(u2, 3)*v2 - 1.0L/8.0L*a[23]*pow(u1, 4)*v2 + (1.0L/8.0L)*a[23]*pow(u2, 4)*v2 -
             1.0L/2.0L*a[24]*u1*pow(v2, 2) + (1.0L/2.0L)*a[24]*u2*pow(v2, 2) - 1.0L/4.0L*a[25]*pow(u1, 2)*pow(v2, 2) + (1.0L/4.0L)*a[25]*pow(u2, 2)*pow(v2, 2) -
             1.0L/6.0L*a[26]*pow(u1, 3)*pow(v2, 2) + (1.0L/6.0L)*a[26]*pow(u2, 3)*pow(v2, 2) - 1.0L/8.0L*a[27]*pow(u1, 4)*pow(v2, 2) + (1.0L/8.0L)*a[27]*pow(u2, 4)*pow(v2, 2) -
             1.0L/2.0L*a[28]*u1*pow(v2, 3) + (1.0L/2.0L)*a[28]*u2*pow(v2, 3) - 1.0L/4.0L*a[29]*pow(u1, 2)*pow(v2, 3) + (1.0L/4.0L)*a[29]*pow(u2, 2)*pow(v2, 3) -
             1.0L/6.0L*a[30]*pow(u1, 3)*pow(v2, 3) + (1.0L/6.0L)*a[30]*pow(u2, 3)*pow(v2, 3) - 1.0L/8.0L*a[31]*pow(u1, 4)*pow(v2, 3) + (1.0L/8.0L)*a[31]*pow(u2, 4)*pow(v2, 3))
            - w1 *
            (-a[0]*u1 + a[0]*u2 - 1.0L/2.0L*a[1]*pow(u1, 2) + (1.0L/2.0L)*a[1]*pow(u2, 2) -
             1.0L/3.0L*a[10]*pow(u1, 3)*pow(v2, 2) + (1.0L/3.0L)*a[10]*pow(u2, 3)*pow(v2, 2) - 1.0L/4.0L*a[11]*pow(u1, 4)*pow(v2, 2) + (1.0L/4.0L)*a[11]*pow(u2, 4)*pow(v2, 2) -
             a[12]*u1*pow(v2, 3) + a[12]*u2*pow(v2, 3) - 1.0L/2.0L*a[13]*pow(u1, 2)*pow(v2, 3) + (1.0L/2.0L)*a[13]*pow(u2, 2)*pow(v2, 3) -
             1.0L/3.0L*a[14]*pow(u1, 3)*pow(v2, 3) + (1.0L/3.0L)*a[14]*pow(u2, 3)*pow(v2, 3) - 1.0L/4.0L*a[15]*pow(u1, 4)*pow(v2, 3) + (1.0L/4.0L)*a[15]*pow(u2, 4)*pow(v2, 3) -
             1.0L/3.0L*a[2]*pow(u1, 3) + (1.0L/3.0L)*a[2]*pow(u2, 3) - 1.0L/4.0L*a[3]*pow(u1, 4) + (1.0L/4.0L)*a[3]*pow(u2, 4) -
             a[4]*u1*v2 + a[4]*u2*v2 -  1.0L/2.0L*a[5]*pow(u1, 2)*v2 + (1.0L/2.0L)*a[5]*pow(u2, 2)*v2 -
             1.0L/3.0L*a[6]*pow(u1, 3)*v2 + (1.0L/3.0L)*a[6]*pow(u2, 3)*v2 - 1.0L/4.0L*a[7]*pow(u1, 4)*v2 + (1.0L/4.0L)*a[7]*pow(u2, 4)*v2 -
             a[8]*u1*pow(v2, 2) + a[8]*u2*pow(v2, 2) - 1.0L/2.0L*a[9]*pow(u1, 2)*pow(v2, 2) + (1.0L/2.0L)*a[9]*pow(u2, 2)*pow(v2, 2))
            + pow(w2, 4) *
            (-1.0L/4.0L*a[48]*u1 + (1.0L/4.0L)*a[48]*u2 - 1.0L/8.0L*a[49]*pow(u1, 2) + (1.0L/8.0L)*a[49]*pow(u2, 2) -
             1.0L/12.0L*a[50]*pow(u1, 3) + (1.0L/12.0L)*a[50]*pow(u2, 3) - 1.0L/16.0L*a[51]*pow(u1, 4) + (1.0L/16.0L)*a[51]*pow(u2, 4) -
             1.0L/4.0L*a[52]*u1*v2 + (1.0L/4.0L)*a[52]*u2*v2 - 1.0L/8.0L*a[53]*pow(u1, 2)*v2 + (1.0L/8.0L)*a[53]*pow(u2, 2)*v2 -
...
double Energy::gradientZMaxComponentOld(const double*& a, double u1, double v1, double u2, double v2, double w2) {
    double G_result;
    G_result =
            a[0]*u1*v1 - a[0]*u1*v2 - a[0]*u2*v1 + a[0]*u2*v2 +
            (1.0L/2.0L)*a[1]*pow(u1, 2)*v1 - 1.0L/2.0L*a[1]*pow(u1, 2)*v2 - 1.0L/2.0L*a[1]*pow(u2, 2)*v1 + (1.0L/2.0L)*a[1]*pow(u2, 2)*v2 +
...
double Energy::gradientXMinComponent(const gridreal*& a, double u1, double v1, double w1, double v2, double w2) {
    ...
    double v22 = pow(v2, 2), v23 = pow(v2, 3), v24 = pow(v2, 4);
    double w22 = pow(w2, 2), w23 = pow(w2, 3), w24 = pow(w2, 4);
    double G_result;
    G_result =
            -w14 *
            ((1.0L/4.0L)*a[48]*v1 - 1.0L/4.0L*a[48]*v2 + (1.0L/4.0L)*a[49]*u1*v1 - 1.0L/4.0L*a[49]*u1*v2 +
...
double Energy::gradientYMaxComponent(const gridreal*& a, double u1, double w1, double u2, double v2, double w2) {
    ...
    double w12 = pow(w1, 2), w13 = pow(w1, 3), w14 = pow(w1, 4);
    double u22 = pow(u2, 2), u23 = pow(u2, 3), u24 = pow(u2, 4);
    double v22 = pow(v2, 2), v23 = pow(v2, 3);
    double w22 = pow(w2, 2), w23 = pow(w2, 3), w24 = pow(w2, 4);
    double G_result;
    G_result =
            -w14 *
...
double Energy::gradientZMaxComponent(const gridreal*& a, double u1, double v1, double u2, double v2, double w2) {
    ...
    double u22 = pow(u2, 2), u23 = pow(u2, 3), u24 = pow(u2, 4);
    double v22 = pow(v2, 2), v23 = pow(v2, 3), v24 = pow(v2, 4);
    double w22 = pow(w2, 2), w23 = pow(w2, 3);
    double G_result;
    G_result =
            a[0]*u1*v1 - a[0]*u1*v2 - a[0]*u2*v1 + a[0]*u2*v2 +
            (1.0L/2.0L)*a[1]*u12*v1 - 1.0L/2.0L*a[1]*u12*v2 - 1.0L/2.0L*a[1]*u22*v1 + (1.0L/2.0L)*a[1]*u22*v2 +
...
double Energy::integralTricubicInterpolationOld(const double*& a, double u1, double v1, double w1, double u2, double v2, double w2) {
    double C_result;
    C_result = - pow(w1, 4) *
               ((1.0L/4.0L)*a[48]*u1*v1 - 1.0L/4.0L*a[48]*u1*v2 - 1.0L/4.0L*a[48]*u2*v1 + (1.0L/4.0L)*a[48]*u2*v2 +
                (1.0L/8.0L)*a[49]*pow(u1, 2)*v1 - 1.0L/8.0L*a[49]*pow(u1, 2)*v2 - 1.0L/8.0L*a[49]*pow(u2, 2)*v1 + (1.0L/8.0L)*a[49]*pow(u2, 2)*v2 +
